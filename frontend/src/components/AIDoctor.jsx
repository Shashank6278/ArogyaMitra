          ...
          <div className="p-3 border-t">
            ...
            <div className="flex items-center gap-2">
              <input
                ...
                className="flex-1 border rounded-xl px-3 py-2 outline-none focus:ring-2 focus:ring-primary/40"
              />
              <input ref={fileRef} type="file" accept="image/*" multiple onChange={onPickImages} className="hidden" />
              <button onClick={() => fileRef.current?.click()} className="px-3 py-2 border rounded-xl">Photo</button>
              <button onClick={send} disabled={loading} className="bg-primary text-white px-4 py-2 rounded-xl disabled:opacity-60">Send</button>
            </div>
